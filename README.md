...
The easiest way to install there scripts is via ReaPack: https://reapack.com/

Import this link in your ReaPack Repository list and you are ready to go!
...
- tdspk - Media Explorer - Query: work-in-progress media explorer tab replacement
