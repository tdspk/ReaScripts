...
if (sampler_found) then
  ...
  script_id = reaper.NamedCommandLookup("_RS1af3d7ebd4211ba5d183d2ff093c0052dbb5fd05");
  ...
  reaper.ShowMessageBox("Global Sampler not loaded!\nPlease insert it into the Master Track to make this toggle work!", "Global Sampler not found", 0);
end
