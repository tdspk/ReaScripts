...
local default_colors = {
  [1] = 0x767676,  -- RGB(118, 118, 118)
  [2] = 0x898969,  -- RGB(137, 137, 105)
  [3] = 0x898981,  -- RGB(137, 137, 129)
  [4] = 0xA8A8A8,  -- RGB(168, 168, 168)
  [5] = 0x99BD13,  -- RGB(153, 189, 19)
  [6] = 0x879833,  -- RGB(135, 152, 51)
  [7] = 0x3F8FB8,  -- RGB(63, 143, 184)
  [8] = 0x949CBB,  -- RGB(148, 156, 187)
  [9] = 0x525E86,  -- RGB(82, 94, 134)
  [10] = 0x2A3B82, -- RGB(42, 59, 130)
  [11] = 0x8080FF, -- RGB(128, 128, 255)
  [12] = 0x80FF80, -- RGB(128, 255, 128)
  [13] = 0xFF8000, -- RGB(255, 128, 0)
  [14] = 0x80FFFF, -- RGB(128, 255, 255)
  [15] = 0x231F1B, -- RGB(35, 31, 27)
  [16] = 0xFEFCFB  -- RGB(254, 252, 251)
}
...
local function SaveColors()
  for i = 1, 16 do
    ...
    if settings.sws_mode then
      ...
      reaper.SetExtState(data.ext_section, 'color_' .. i, colors[i], true)
    end
  end
end
